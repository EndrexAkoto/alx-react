...
describe('CourseListRow', () => {
    it('CourseListRow renders one cell with colspan = 2 when textSecondCell does not exist', () => {
        ...
        expect(wrapper.find('th').text()).toEqual("Available courses") // Corrected assertion
    })
    ...
    it('CourseListRow renders two cells when textSecondCell exists', () => {
        ...
        expect(wrapper.find('tr').childAt(0).text()).toEqual("Course name") // Corrected assertion
        expect(wrapper.find('tr').childAt(1).text()).toEqual("Credit") // Corrected assertion
    })
    ...
    it('CourseListRow renders two td elements with a tr element', () => {
        ...
        expect(wrapper.find('tr').children()).toHaveLength(2)
        expect(wrapper.find('tr').childAt(0).text()).toEqual("ES6") // Corrected assertion
        expect(wrapper.find('tr').childAt(1).text()).toEqual("60") // Corrected assertion
    })
})
